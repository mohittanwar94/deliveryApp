package com.ezymd.restaurantapp.delivery.push;
...
public class SinchService extends Service {
    ...
    private static final String APP_KEY = "f8886d1c-35f7-44dc-abd7-ca5a0649e0f2";
    private static final String APP_SECRET = "5KGC5IJm70y0YPWcfFYZXA==";
    private static final String ENVIRONMENT = "clientapi.sinch.com";
    private static final String ENVIRONMENT_TEST = "sandbox.sinch.com";
    ...
    private void createClient(String userName) {
        String inv = ServerConfig.IS_TESTING ? ENVIRONMENT_TEST : ENVIRONMENT;
    ...
    private class PersistedSettings {
        ...
        private static final String PREF_KEY = "SinchCall";
